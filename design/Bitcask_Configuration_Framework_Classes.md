# Bitcask Configuration Framework — Class Design

> Companion to `Bitcask_Configuration_Framework_Design.md`. Contains the
> reconciled class stubs (fields, constructors, method signatures, Javadoc)
> for every component in the configuration loading pipeline. No method
